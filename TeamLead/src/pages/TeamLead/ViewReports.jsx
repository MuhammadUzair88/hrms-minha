...
import { Delete, Download, Eye, Flag, Pencil, View } from "lucide-react";
  ...
  const TeamActions = [
    {
      title: "View",
      icon: Eye,
      onClick: (task) => Navigate(`/view-single-report/${task.id}`),
    },
    {
      title: "Edit",
      icon: Pencil,
    ...
    <div className="bg-white w-full flex flex-col">
      ...
      <div className="px-[39px] pt-[26px]">
        <Table
          ...
          data={paginatedData}
          renderRow={(task) => {
            const assign = getEmployeeById(task.assignedTo);
