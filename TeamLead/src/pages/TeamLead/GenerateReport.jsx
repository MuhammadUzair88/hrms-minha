// src/pages/Tasks/GenerateReport.jsx
...
const GenerateReport = () => {
  ...
  const handleSave = () => {
    ...
    alert("Report generated! Check console for output.");
  };
      ...
      <div className="p-7 w-full">
        <div className="bg-[#E3E3E3]/15 rounded-xl p-6 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="flex flex-col gap-2">
              <label className="font-semibold text-[21px]">Apk Link</label>
              <input
                type="url"
                className="rounded-lg bg-white border h-[60px] px-4 text-lg focus:outline-none"
                value={apkLink}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                type="text"
                className="rounded-lg bg-white border h-[60px] px-4 text-lg"
                value={assignedBy}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="flex flex-col gap-2">
              ...
              <label className="w-full h-[60px] border border-[#A2A1A8]/15 rounded-lg bg-white flex items-center justify-center text-[#6F6F6F] cursor-pointer">
                No File Uploaded
              </label>
            </div>
