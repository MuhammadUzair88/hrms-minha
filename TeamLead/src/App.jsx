...
import Assign from "./pages/TeamLead/Assign";
import CheckPerformance from "./pages/TeamLead/CheckPerformance";
import ViewAssign from "./pages/TeamLead/ViewAssign";
import ViewTask from "./pages/TeamLead/ViewTask";
import EditTask from "./pages/TeamLead/EditTask";
import ViewReports from "./pages/TeamLead/ViewReports";
import ViewSingleReport from "./pages/TeamLead/ViewSingleReport";
import GenerateReport from "./pages/TeamLead/GenerateReport";
