...
// Import dummy data
import { dummyEmployees, dummyAttendanceRecords } from "../../assets/assets";
...
const AllEmployees = () => {
  ...
  useEffect(() => {
    const getEmployees = () => {
      ...
      const merged = dummyAttendanceRecords.records.map((record) => {
      ...
      setEmployeesWithAttendance(merged);
    };
